...
<div class="col-md-10 col-md-offset-1 text-center">
            <div class="panel panel-success">
               <div class="panel-heading">
                  <h4 style="color: #899B82;">Editar Delegado</h4>
               </div>
 ...
 <div class="form-group">
   ...
   value= "{{$eDelAdmin->IDPerson}}" style = "display:none;">
...
<div class="col-lg-6">
   <input readonly type="text" class="form-control" id="IDPerson" name = "IDPerson" 
      value= "{{$eDelAdmin->IDPerson}}">
</div>
    
    
    <input type="text" class="form-control" id="name" name = "name"
   value= "{{$eDelAdmin->name}}" style = "display:none;">
...
<div class="col-lg-6">
   <input type="text" class="form-control" id="name" name = "name" pattern="^[\s\S]{0,25}$" title="Maximo 25 letras"
      value= "{{$eDelAdmin->name}}" required autofocus>
</div>
    
    <input type="text" class="form-control" id="lastName1" name = "lastName1"
   value= "{{$eDelAdmin->lastName1}}" style = "display:none;">
...
<div class="col-lg-6">
   <input type="text" class="form-control" id="lastName1" name = "lastName1" pattern="^[\s\S]{0,12}$" title="Maximo 12 letras"
      value= "{{$eDelAdmin->lastName1}}" required autofocus>
</div>
    
<input type="text" class="form-control" id="lastName2" name = "lastName2"
   value= "{{$eDelAdmin->lastName2}}" style = "display:none;">
...
<div class="col-lg-6">
   <input type="text" class="form-control" id="lastName2" name = "lastName2" pattern="^[\s\S]{0,12}$" title="Maximo 12 letras"
      value= "{{$eDelAdmin->lastName2}}" required autofocus>
</div>
    
 <label for="" class="col-lg-4 control-label">Fecha de nacimiento</label>
    <div class="col-lg-6">
        <div class='input-group date' id='birthDate'>
            <input value= "{{$eDelAdmin->birthDate}}" name = "birthDate" type='text' class="form-control" id='datepicker' pattern="^\d{4}-((0\d)|(1[012]))-(([012]\d)|3[01])$" title="La fecha debe ser año-mes-dia"  autocomplete='off' onchange="changeEventHandler(event);" required autofocus/>
  ...
  <input type="text" class="form-control" id="telephone" name = "telephone"
   value= "{{$eDelAdmin->telephone}}" style = "display:none;">
...
<div class="col-lg-6">
   <input type="text" class="form-control" id="telephone" name = "telephone" pattern="^[0-9]{1}[\-][0-9]{3}[\-][0-9]{2}[\-][0-9]{2}"  title="Formato incorrecto, Solo 8 digitos son permitidos y con el formato 2-345-67-89" placeholder="2-494-01-02"
      value= "{{$eDelAdmin->telephone}}">
</div>      
        
     <input type="text" class="form-control" id="email" name = "email"
   value= "{{$eDelAdmin->email}}" style = "display:none;">
<label for="" class="col-lg-4 control-label">Correo electronico</label>
<div class="col-lg-6">
   <input type="email" class="form-control" id="email" name = "email"
      value= "{{$eDelAdmin->email}}">
</div>    
        

</div>
<div class="col-lg-offset-8 col-lg-4">
      <a href="{{URL::to('showD/')}}"><button type="button" class="btn btn-info"><span class="glyphicon"> </span><span>Cancelar</span></button></a>
